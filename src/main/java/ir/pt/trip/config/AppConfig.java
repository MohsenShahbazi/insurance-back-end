...
//    @Bean
//    UserDetailAspect userDetailAspect() {
//        return new UserDetailAspect();
//    }
...
//    }
    ...
    /*@Bean(name = "CoreLogger")
    Logger logger() {
        return new JLogger(dashboard().HIBERNATE_JDBC_URL, dashboard().HIBERNATE_USER, dashboard().HIBERNATE_PASSWORD);
    }*/
